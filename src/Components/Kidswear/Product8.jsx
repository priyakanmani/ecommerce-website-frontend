...
const ProductDetails = () => {
    ...
    const [productImage] = useState('https://www.rajeshkidswear.com/VendorAssets/1031/StoreImages/extralarge/117501180MAROON.jpg');
        ...
        <div className="product-wrapper">
            <div className="product-container">
                ...
                <div className="product-details">
                    <h1 className="product-title">Party Wears</h1>
