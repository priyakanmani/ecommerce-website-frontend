...
const ProductDetails = () => {
    ...
    const [productImage] = useState('https://www.pinkblueindia.com/wp-content/uploads/2024/01/twinsbabysatinnightsuit.jpg');
        ...
        <div className="product-wrapper">
            <div className="product-container">
                ...
                <div className="product-details">
                    <h1 className="product-title">Night Dress</h1>
