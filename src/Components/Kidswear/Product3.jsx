...
const ProductDetails = () => {
    ...
    const [productImage] = useState('https://www.fayonkids.com/cdn/shop/files/manufactured-by-fayon-kids-noida-u-p-lilac-neoprene-dress-for-girls-40946014781696.jpg?v=1715940305&width=533');
        ...
        <div className="product-wrapper">
            <div className="product-container">
                ...
                <div className="product-details">
                    <h1 className="product-title"> Party Wear</h1>
