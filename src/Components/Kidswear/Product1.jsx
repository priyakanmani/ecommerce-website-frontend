...
const ProductDetails = () => {
    ...
    const [productImage] = useState('https://www.seasonbazaar.com/wp-content/uploads/2018/07/63a7fbf0-a69c-4b3b-8f5a-550a66e6d6dc.jpg');
        ...
        <div className="product-wrapper">
            <div className="product-container">
                ...
                <div className="product-details">
                    <h1 className="product-title">Tranditional Wear</h1>
