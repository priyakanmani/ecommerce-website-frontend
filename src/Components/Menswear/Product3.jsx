...
const ProductDetails = () => {
    ...
    const [productImage] = useState('https://www.bonsoir.co.in/cdn/shop/products/Jacquard_Indo-western_Achkan_Set.jpg?crop=center&height=844&v=1730193044&width=650');
