...
const ProductDetails = () => {
    ...
    const [productImage] = useState('https://assets2.andaazfashion.com/media/catalog/product/cache/1/image/800x1200/a12781a7f2ccb3d663f7fd01e1bd2e4e/c/r/cream-dupion-silk-men-kurta-with-dhoti-mkpa0568-1_1.jpg');
        ...
        <div className="product-wrapper">
            <div className="product-container">
                ...
                <div className="product-details">
                    <h1 className="product-title">Designer Party Wear</h1>
