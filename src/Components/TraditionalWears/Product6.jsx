...
const ProductDetails = () => {
    ...
    const [productImage] = useState('https://lh7-us.googleusercontent.com/iPWfJvypDLiA1K9LjNALMJRJAwtRgwTYF49OwTwbL4vPXfsKRNOJ53HLbFYJceeIh7z4SotbyQG3uTK1JiQg5reO060kkgTlzXHZ8OKf1dIMks1pyuw0Fhsju4Qe-JG0ytY_EMLkPYEpz_y5gLtRej0');
        ...
        <div className="product-wrapper">
            <div className="product-container">
                ...
                <div className="product-details">
                    <h1 className="product-title">Traditional Wear</h1>
                    <div className="product-price">₹1150.00</div>
                    ...
                    <div>
                        ...
                        Traditional dresses reflect the rich heritage and cultural identity of a region or community. They are crafted with intricate designs, vibrant colors, and symbolic patterns, embodying the essence of tradition and craftsmanship. Perfect for festive occasions and celebrations, these garments blend elegance with cultural significance.
                        </p>
                    </div>
