...
const ProductDetails = () => {
    ...
    const [productImage] = useState('https://resources.indianclothstore.com/resources/productimages/Grey-Silk-Saree-With-Blouse-757122012024.jpg');
        ...
        <div className="product-wrapper">
            <div className="product-container">
                ...
                <div className="product-details">
                    <h1 className="product-title">Traditinal Wear</h1>
                    <div className="product-price">₹1099.99</div>
