...
const ProductDetails = () => {
    ...
    const [productImage] = useState('https://i.etsystatic.com/26009472/r/il/07b340/3155685541/il_570xN.3155685541_i4xy.jpg');
        ...
        <div className="product-wrapper">
            <div className="product-container">
                ...
                <div className="product-details">
                    <h1 className="product-title">Traditionnal Wear</h1>
                    <div className="product-price">₹1329.99</div>
