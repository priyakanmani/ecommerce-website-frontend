...
const ProductDetails = () => {
    ...
    const [productImage] = useState('https://lh7-us.googleusercontent.com/duIyz-On_X4piT-6JGdny0gM-LZn8SnDjaQyKmTg_QSJuOP_sPD6NuSfeyXHU-_-27JPAXLW2TRKZCIVVOR9GQvSAnzz9Ythyv6AfoFk4KZ8vr3anFN9EjKfdSrLlZkNQdmfSGXLBauqwMTFk8Txbtw');
        ...
        <div className="product-wrapper">
            <div className="product-container">
                ...
                <div className="product-details">
                    ...
                    <div className="product-price">₹1299.99</div>
