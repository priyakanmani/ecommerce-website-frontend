...
const ProductDetails = () => {
    ...
    const [productImage] = useState('https://i0.wp.com/www.reshmafattepurkar.com/wp-content/uploads/2021/04/south-indian-look-for-wedding.jpg?ssl=1');
        ...
        <div className="product-wrapper">
            <div className="product-container">
                ...
                <div className="product-details">
                    ...
                    <div className="product-price">₹1249.99</div>
